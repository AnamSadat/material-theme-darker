...
| Element / Elemen | Color / Warna              | Hex       |
| ---------------- | -------------------------- | --------- |
| Background       | Almost Black / Hitam Pekat | `#0a0a0a` |
| Sidebar          | Dark Gray / Abu Gelap      | `#121212` |
| Accent           | Yellow / Kuning            | `#ffcb6b` |
| Links            | Blue / Biru                | `#82aaff` |
| Keywords         | Purple / Ungu              | `#c792ea` |
| Strings          | Green / Hijau              | `#c3e88d` |
| Operators        | Cyan                       | `#89ddff` |
| Numbers          | Orange / Oranye            | `#f78c6c` |
| Comments         | Gray / Abu                 | `#546e7a` |

## Syntax Highlighting

| Token          | Color / Warna                 |
| -------------- | ----------------------------- |
| Comment        | Gray / Abu `#546e7a` (italic) |
| Keyword        | Cyan `#89ddff`                |
| String         | Green / Hijau `#c3e88d`       |
| Number/Boolean | Orange / Oranye `#f78c6c`     |
| Function       | Yellow / Kuning `#ffcb6b`     |
| Variable       | White / Putih `#ffffff`       |
| Property       | Orange / Oranye `#f78c6c`     |
| Operator       | Purple / Ungu `#c792ea`       |
| Tag            | Red / Merah `#f07178`         |
...
- Author: Lumiere
- Inspired by / Terinspirasi dari: [Material Theme](https://material-theme.site/) for VS Code
- Icons / Ikon: [Lucide](https://lucide.dev/)
